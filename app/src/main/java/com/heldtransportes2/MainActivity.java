...
public class MainActivity extends AppCompatActivity  implements LocationListener{
    ...
    private String getUrl(){
        ...
        //url = "http://heldtransportes.com/mobilePrincipal.php?destino=MN&versao="+ConfiguracaoCliente.versaoApp+"&la=&lo=";
        url = "http://mototaxionline.com/mobilePrincipal.php?destino=MN&versao="+ConfiguracaoCliente.versaoApp+"&la=&lo=";
        return url;
    }

    private String getUrl(double latitude, double longitude){

        //url = "http://heldtransportes.com/mobilePrincipal.php?destino=MN&versao="+ConfiguracaoCliente.versaoApp+"&la="+latitude+"&lo="+longitude;
        url = "http://mototaxionline.com/mobilePrincipal.php?destino=MN&versao="+ConfiguracaoCliente.versaoApp+"&la="+latitude+"&lo="+longitude;
        return url;
    }
    ...
    private void dialogoPermissaoGps(){
        ...
        builder.setMessage("App HeldTransportes solicita GPS para ter acesso sua localização  atual,  deseja habilitar?");
